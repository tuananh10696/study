...
// bai 3
var changeColor = document.querySelector('#color-box')
var colors = ['red', 'green', 'blue', 'black', 'yellow', 'purple', 'orange', 'pink', 'brown', 'cyan', 'magenta'];

// ham thong bao mau hien tai
function nowBackgroundColor() {
    let nowBgrColor = document.querySelector('.check-color')
    nowBgrColor.innerText = 'Màu hiện tại: ' + changeColor.style.backgroundColor
}

// ham thay doi mau cua box
function changeBackgroundColor() {
    changeColor.style.backgroundColor = colors[Math.floor(Math.random() * 11)]
    nowBackgroundColor()
}

// goi ham thay doi mau khi di chuot vao
